...
(defrule d-UrgentCalls
  ...
  (or ((logical (Neverlookup  NeverlookupYes))(logical (HAHA HAHAYEAH)))
      ((logical (UrgentCalls UrgentCallsAgreement))(logical (HAHA HAHAYEAH))))
...
(defrule d-DontLookBack
(or (logical (HardEarned HumanATM))(logical(PonyUp HumanATM))(logical(AppleCare HumanATM))(logical (GetSomething GetSomethingSweet)))
=>
(assert (UI-state 	(display DontLookBack)
			(state final)))
			)

(defrule d-DontGetPhone
